    ...
    return (
        <div className='w-full flex justify-center h-auto lg:h-[100vh]'>
            <div className='flex-col items-center flex w-full '>
                ...
                <div className='flex flex-col-reverse lg:flex lg:flex-row w-full justify-between h-auto lg:h-[60vh] gap-4'>
                    ...
                    <div className='w-full lg:w-1/3 h-full gap-6 flex flex-col p-0 lg:p-2'>
                        <div className='w-full flex justify-center bg-pink-600 cursor-pointer hover:bg-blue-600 text-white py-2 px-4  focus:outline-none focus:ring focus:border-blue-300'>
                            <p className='text-xl font-semibold text-white'>{Math.floor(timeRemaining / 60)}:{(timeRemaining % 60).toString().padStart(2, '0')}</p>
                        </div>
                        <div className="grid grid-cols-5 lg:grid-cols-3 gap-2 lg:gap-8 ml-8 lg:ml-0">
                        ...
                        <div className='flex flex-col gap-2 ml-8 lg:ml-0'>
                            <div className='flex items-center'>
                                ...
                                <div className='lg:text-xl ml-2 text-sm font-semibold'>Visited & Unanswered</div>
                            </div>
                            <div className='flex items-center'>
                                <div className="h-6 w-6  rounded-full flex items-center justify-center cursor-pointer bg-green-300"></div>
                                <div className='lg:text-xl ml-2 text-sm font-semibold'>Answered</div>
                            </div>
                            <div className='flex items-center'>
                                <div className="h-6 w-6  rounded-full flex items-center justify-center cursor-pointer bg-gray-100"></div>
                                <div className='lg:text-xl ml-2 text-sm font-semibold'>Unvisited & Unanswered</div>
                            </div>
                        </div>
